...
CREATE TABLE `article_comments` (
  ...
  `ariticleno` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`no`),
  KEY `FK9xraqyq3svmt59sej285fr521` (`ariticleno`),
  CONSTRAINT `FK9xraqyq3svmt59sej285fr521` FOREIGN KEY (`ariticleno`) REFERENCES `article` (`article_no`)
